package com.dnb.authservice.config;
...
import com.dnb.authservice.jwt.AuthTokenFilter;
import com.dnb.authservice.jwt.JWTAccessDeniedHandler;
import com.dnb.authservice.jwt.JwtAuthenticationEntryPoint;
import com.dnb.authservice.jwt.JwtUtils;
import com.dnb.authservice.security.CustomUserDetailsService;
...
public class SecurityConfig {
	...
	public WebSecurityCustomizer webSecurityCustomizer() {
		return (web) -> web.ignoring().requestMatchers("/authenticate/signup", "/authenticate/login",
