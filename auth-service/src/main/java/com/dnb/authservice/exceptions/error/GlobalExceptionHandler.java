package com.dnb.authservice.exceptions.error;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
	...
	// handleUserNotFoundException : triggers when there is not resource with the
	// specified ID in User
	...
	// handleRoleException : triggers when there is not resource with the specified
	// ID in RefreshToken
	...
	// handleRefreshTokenException : triggers when there is not resource with the
	// specified ID in RefreshToken
